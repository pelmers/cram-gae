(function() {
    ...
    function getRatio() {
        return parseFloat(document.getElementById("ratioInput").innerHTML.slice(7));
    }

    // bind event listeners
    var shapeDivs = document.getElementById("shapeSelect").children;
    ...
    document.getElementById("ratioInput").addEventListener('wheel', function(e) {
        ...
        this.innerHTML = "Ratio: " + Math.max(0.05,
                getRatio() + -0.05*sign(e.deltaY)).toFixed(2);
    });
